  ...
  return (
    <div className="flex h-full items-center justify-center px-4 py-10 md:px-6 md:py-14">
      <div className="ai-lab-landing-panel mx-auto flex w-full max-w-4xl flex-col items-center gap-8 text-center">
        ...
        <p className="mx-auto max-w-[42rem] text-[12px] leading-8 tracking-[0.02em] text-muted-foreground md:text-[13px]">
            {emptyLabel}
          </p>
        </div>
        ...
        <p className="text-[10px] font-medium uppercase leading-6 tracking-[0.12em] text-muted-foreground">
          {t("landingPromptHint")}
        </p>
      </div>
    </div>
