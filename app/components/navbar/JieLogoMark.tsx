...
const JieLogoMark = React.forwardRef<SVGSVGElement, JieLogoMarkProps>(
  ({ className, ...props }, ref) => (
    ...
    >
      <path
        className="origin-center motion-reduce:animate-none group-hover:animate-[jie-logo-line-tilt-top_420ms_ease-out]"
      ...
      />
      <path
        className="origin-center motion-reduce:animate-none group-hover:[animation-delay:35ms] group-hover:animate-[jie-logo-line-tilt-bottom_420ms_ease-out]"
