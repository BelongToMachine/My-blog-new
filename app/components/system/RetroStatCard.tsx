...
export function RetroStatCard({
  ...
  return (
    <div
      className={cn(
        "pixel-panel panel-grid flex flex-col border border-border/80 bg-card/88 px-6 py-7 sm:px-5 sm:py-6 lg:p-4",
        className
      )}
      {...props}
    >
      <div className="terminal-label">{label}</div>
      <div className="flex flex-1 flex-col items-center justify-center gap-4 pt-5 sm:gap-3 sm:pt-4 lg:gap-2 lg:pt-3">
