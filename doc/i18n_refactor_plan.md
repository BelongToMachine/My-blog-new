...
|---|---|---|
| `Hero.tsx` | Mixed | `"Heya I'm"` (EN), `"开发者"` (CN) type animation |
...
```json
{
  ...
  "hero": {
    "greeting": "Heya I'm",
    "typeSequence": ["Jie", "a web developer", "开发者"]
  },
  "home": {
  ...
  "meta": {
    "homeTitle": "Developer — Front-End Developer & AI Prompt Engineer",
    "homeDescription": "Portfolio of Developer — a front-end developer specializing in React, Next.js, TypeScript, and AI.",
...
```json
{
  ...
  "meta": {
    "homeTitle": "开发者 — 前端开发工程师 & AI 提示词工程师",
    "homeDescription": "开发者（Developer）的作品集——专注于 React、Next.js、TypeScript 和 AI 集成的前端开发者。",
    "blogsTitle": "博客列表",
...
> [!NOTE]
> **`TypeAnimation` sequence in `Hero.tsx`** — the animation array `["Jie", 1500, "a web developer", 1500, "开发者", 1500]` should be sourced from the translation file as an array, then used in the component. This requires special handling since JSON arrays work fine here.
